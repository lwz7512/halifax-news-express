...
class CityNewsLocalSpider(scrapy.Spider):
    ''' City news scraper. - CityNews Halifax (Local) @2025-03-27'''

    name = 'local'
    category_url = 'https://halifax.citynews.ca/category/local/'
    ...
    full_json_path = f'data/cn_local_{today_str}.json'
    ...
    def parse(self, response):
        ...
        print('====== detected first article: CityNews - Local ===============')
